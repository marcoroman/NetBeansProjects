...
*
* purpose: Creates a color game and implements a mouse listener
* to allow the user to interact with five randomly generated and
* colored circles.
*
****************************************************************/ 
...
public class ColorGame extends javax.swing.JFrame implements MouseListener{
    ...
    public void paint(Graphics g){
        ...
        String[] spellColor = new String[5];
        int k = 0;
        j = 0;
        ...
        for(int i = 0; i < ellipses.length; ++i){
            if (ellipses[i].contains(e.getX(), e.getY()) ){
                ...
                if(gameTracker >= 5){
                    ...
                    JOptionPane.showMessageDialog(frame, "Interesting.. You got " + (points / 100) + "/5.",
                        "Game Complete", 
    ...
    //The mouseListener methods that had to be overwritten (it is an abstract class)
    @Override
